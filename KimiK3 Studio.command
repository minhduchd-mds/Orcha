...
if [[ "$health" != *'7.2.0'* ]]; then osascript -e 'display alert "KimiK3-Lite Studio" message "Không khởi động được runtime v7.2. Kiểm tra Python/Ollama và log trong ~/Library/Logs." as critical' >/dev/null 2>&1 || true; exit 1; fi
