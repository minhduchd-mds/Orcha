...
class H70(v69.H69):
    def _index70(self):
        ...
        text=text.replace('</head>','<link rel="stylesheet" href="/parallel-agents.css"><link rel="stylesheet" href="/agent-team.css"><link rel="stylesheet" href="/final-intelligence.css"><link rel="stylesheet" href="/hermes.css"><link rel="stylesheet" href="/harness.css"><link rel="stylesheet" href="/project-workspace.css"></head>')
        text=text.replace('</body>','<script src="/parallel-agents.js"></script><script src="/agent-team.js"></script><script src="/final-intelligence.js"></script><script src="/hermes.js"></script><script src="/harness.js"></script><script src="/project-workspace.js"></script></body>')
        text=text.replace('Local Workspace · v6.4','Local Workspace · v7.0').replace('Local Workspace · v6.8','Local Workspace · v7.0')
    ...
    def do_GET(self):
        ...
        if path=='/health':return self.send_json(200,{'ok':True,'version':'7.0.0','hermes_foundation':True,'deepseek_harness_patterns':True,'event_sourced_runs':True,'crash_recovery':True,'tool_result_spill':True,'verification_recipes':True,'project_workspace':True,'persistent_tasks':True,'resume':True,'approval_inbox':True,'checkpoints':True,'harness':harness.status()})
